  ...
  />
    <div id="login-form">
      <div class="login-form-header">
        ...
        <span style="position: absolute; width: 24px;height: 24px;top: 16px;left: 560px"><i class="fa fa-times" style="font-size: 20px; padding-right: 5px;padding-top: 5px;"></i></span>
      </div>
      <div id="login-body">
        ...
        >
          ...
          ><span
            ><a href="google.com" id="forgot-password" style="text-decoration: none;">Quên mật khẩu?</a></span>
        ...
        >
          <span class="otherway"
            ><i class="fa fa-brands fa-facebook" style="font-size: 16px; padding-right: 5px"></i>Facebook</span
          >
          <span class="otherway"
            ><i
        ...
        <p class="footer">
          Bạn chưa có tài khoản? <a href="google.com" style="text-decoration: none;">Đăng ký ngay!</a>
        </p>
      </div>
    </div>
  </div>
...
.login-button:hover {
  background: var(--Green-hover, #14a760);
  box-shadow: 0px 2px 10px 0px rgba(244, 103, 0, 0.1);
  cursor: pointer;
}
